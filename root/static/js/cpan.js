...
$(document).ready(function() {
    ...
    function collapse_pod_errors(top) {
        top.find('.pod-errors').addClass('collapsed');
        top.find('.pod-errors > p:first-child').click(function() {
            $(this).parent().toggleClass('collapsed');
        });
    }
    collapse_pod_errors($('.pod'));
